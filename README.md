# Love and London Shopify Website Guide

## Overview

This document serves as a guide for the updated website files for the Love and London Shopify websites. This repository includes all files that have been added, updated, or changed.
